...
{
	final String FILEPATH = "C:\\Users\\Kristof\\Desktop\\NewMp3.mp3";
...
//			System.out.println("read " + totalRead + " bytes.");
			...
			System.out.println(String.format("%.1f","Downloaded "+ percentage) + "  %");
...
//		dos.close();
	...
	{
		new JavanymousClient("localhost",8888,Command.JOIN);
	}
